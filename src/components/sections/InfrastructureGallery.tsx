    ...
    <section className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 md:mb-24 text-left">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white uppercase tracking-tighter">
        ...
        <div className="flex flex-col gap-16 sm:gap-24 md:gap-32">
          ...
          >
            <div className="order-2 lg:order-1">
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white uppercase tracking-tight mb-4 sm:mb-6">
                Nationwide Cold-Chain Fleet
              </h3>
              <p className="text-base md:text-lg text-slate-400 leading-relaxed mb-6 sm:mb-8">
            ...
            <div className="order-1 lg:order-2 relative aspect-video lg:aspect-square overflow-hidden rounded-2xl group min-h-[250px] sm:min-h-[300px] w-full bg-slate-800">
              <img 
          ...
          <motion.div 
            ...
            className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-24 items-center"
          >
            <div className="relative aspect-video lg:aspect-square overflow-hidden rounded-2xl group min-h-[250px] sm:min-h-[300px] w-full bg-slate-800">
              <img 
                loading="lazy" decoding="async"
          ...
          >
            ...
            <div className="order-1 lg:order-2 relative aspect-video lg:aspect-square overflow-hidden rounded-2xl group min-h-[250px] sm:min-h-[300px] w-full bg-slate-800">
              <img 
                loading="lazy" decoding="async"
                src="https://images.unsplash.com/photo-1494412651409-8963ce7935a7?auto=format&fit=crop&q=70&w=1000" 
